  ...
  return (
    <S.AddressForm id={formId} ref={formRef} onSubmit={handleSubmit}>
      <S.Wrapper>
        <S.RowWithTwoCells>
          <TextField
            dataCy="addressFormFirstNameField"
            name="firstName"
            label="First Name"
          ...
          />
          <TextField
            dataCy="addressFormLastNameField"
            name="lastName"
            label="Last Name"
        ...
        <S.RowWithTwoCells>
          <TextField
            dataCy="addressFormCompanyNameField"
            name="companyName"
        ...
        <S.RowWithOneCell>
          <TextField
            dataCy="addressFormStreetAddress1Field"
            name="streetAddress1"
        ...
        <S.RowWithOneCell>
          <TextField
            dataCy="addressFormStreetAddress2Field"
            name="streetAddress2"
        ...
        <S.RowWithTwoCells>
          ...
          />
          <TextField
            dataCy="addressFormPostalCodeField"
            name="postalCode"

...
export const grayLight = "#EFF5F8";
export const green = "#3ed256";
export const overlayColor = "rgba(199, 207, 207, 0.8)";
export const rose = "#c22d74";
export const turquoise = "#0D233F";
export const turquoiseDark = "#0D233F";
export const turquoiseLight = "#EFF5F8";
export const turquoiseTransparent = "#EFF5F8";
export const white = "#fff";
export const tabelGray = "#eaeaea";
export const darkGreen = "#0D233F";

...
import { Category_attributes_edges_node } from "../../app/views/Category/types/Category";
import { Collection_attributes_edges_node } from "../../app/views/Collection/types/Collection";
import { SearchProducts_attributes_edges_node } from "../../app/views/Search/types/SearchProducts";
